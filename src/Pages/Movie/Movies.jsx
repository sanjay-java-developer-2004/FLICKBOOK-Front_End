...
export default function Movies() {
    ...
    //                                     <img src={`data:${movie.imgtype};base64,${movie.imgdata}` } alt={movie.moviename} 
    ...
    //                                         </svg>{movie.moviegenre}</p>
    //                                     </div>

    //                                     <div className="auth-movie-sub-footer">
    //                                         <p><i class="fa-regular fa-calendar"></i>{movie.releasedate}</p>
    //                                     </div>
